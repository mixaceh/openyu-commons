...
public final class EntityHelper extends BaseHelperSupporter implements Supporter {
	private static final transient Logger LOGGER = LoggerFactory.getLogger(EntityHelper.class);

	public static final String DEFAULT_AUDIT_USER = "sys";

	private EntityHelper() {
		throw new HelperException(
				new StringBuilder().append(EntityHelper.class.getName()).append(" can not construct").toString());
	...
	protected static boolean audit(AuditEntity auditEntity, String modifiedUser) {
		...
		if (auditEntity != null) {
			if (auditEntity.getCreateUser() == null && auditEntity.getCreateDate() == null) {
				...
				auditEntity.setModifiedUser(modifiedUser == null ? DEFAULT_AUDIT_USER : modifiedUser);
	 ...
	 * @param name
	 */
	protected static void processFilterName(Collection<LocaleNameEntity> values, Locale locale, String name) {
	 ...
	 * @return
	 */
	protected static LocaleNameEntity getFilterNameEntity(LocaleNameEntity value, Locale locale, String name) {
