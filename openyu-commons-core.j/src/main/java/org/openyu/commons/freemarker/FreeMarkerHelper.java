...
public final class FreeMarkerHelper extends BaseHelperSupporter {

	private static final transient Logger LOGGER = LoggerFactory.getLogger(FreeMarkerHelper.class);

	private FreeMarkerHelper() {
		throw new HelperException(
				new StringBuilder().append(FreeMarkerHelper.class.getName()).append(" can not construct").toString());
	}
