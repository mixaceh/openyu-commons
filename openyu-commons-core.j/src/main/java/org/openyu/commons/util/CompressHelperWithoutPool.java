...
public final class CompressHelperWithoutPool extends BaseHelperSupporter {
	...
	// public static SoftReferenceCacheFactory<CompressProcessor>
	// getCompressProcessorCacheFactory() {
	// return compressProcessorCacheFactory;
	// }
	//
	// public static void setCompressProcessorCacheFactory(
	// SoftReferenceCacheFactory<CompressProcessor>
	// compressProcessorCacheFactory) {
	// CompressHelper.compressProcessorCacheFactory =
	// compressProcessorCacheFactory;
	// }
