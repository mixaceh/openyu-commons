...
@Proxy(lazy = false)
@org.hibernate.annotations.Table(appliesTo = "test_dog", indexes = { @org.hibernate.annotations.Index(name = "idx_test_dog_valid_id", columnNames = {
		"valid", "id" }) })
// --------------------------------------------------
// hibernate search
// --------------------------------------------------
@Indexed
public class DogPoImpl implements NamesEntity, Serializable
{
