...
public interface HzSession extends BaseModel, Abortable, Closeable {
	...
	HTableDescriptor getTableDescriptor(byte[] tableName) throws TableNotFoundException, IOException;
	...
	void addColumn(String tableName, HColumnDescriptor column) throws IOException;
	...
	void modifyColumn(String tableName, HColumnDescriptor descriptor) throws IOException;
	...
	boolean closeRegionWithEncodedRegionName(String encodedRegionName, String serverName) throws IOException;
	...
	void flush(byte[] tableNameOrRegionName) throws IOException, InterruptedException;

	void compact(String tableNameOrRegionName) throws IOException, InterruptedException;

	void compact(byte[] tableNameOrRegionName) throws IOException, InterruptedException;

	void compact(String tableOrRegionName, String columnFamily) throws IOException, InterruptedException;

	void compact(byte[] tableNameOrRegionName, byte[] columnFamily) throws IOException, InterruptedException;

	void majorCompact(String tableNameOrRegionName) throws IOException, InterruptedException;

	void majorCompact(byte[] tableNameOrRegionName) throws IOException, InterruptedException;

	void majorCompact(String tableNameOrRegionName, String columnFamily) throws IOException, InterruptedException;

	void majorCompact(byte[] tableNameOrRegionName, byte[] columnFamily) throws IOException, InterruptedException;
	...
	void assign(byte[] regionName) throws MasterNotRunningException, ZooKeeperConnectionException, IOException;

	void unassign(byte[] regionName, boolean force)
			throws MasterNotRunningException, ZooKeeperConnectionException, IOException;

	boolean balanceSwitch(boolean b) throws MasterNotRunningException, ZooKeeperConnectionException;
	...
	void split(String tableNameOrRegionName) throws IOException, InterruptedException;

	void split(byte[] tableNameOrRegionName) throws IOException, InterruptedException;

	void split(String tableNameOrRegionName, String splitPoint) throws IOException, InterruptedException;

	void split(byte[] tableNameOrRegionName, byte[] splitPoint) throws IOException, InterruptedException;
	...
	HTableDescriptor[] getTableDescriptors(List<String> tableNames) throws IOException;
	...
	void snapshot(SnapshotDescription snapshot) throws IOException, SnapshotCreationException, IllegalArgumentException;

	long takeSnapshotAsync(SnapshotDescription snapshot) throws IOException, SnapshotCreationException;
	...
	Object[] batch(String tableName, List<? extends Row> paramList) throws IOException, InterruptedException;
	...
	/** @deprecated */
	Result getRowOrBefore(String tableName, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2) throws IOException;

	ResultScanner getScanner(String tableName, Scan paramScan) throws IOException;

	ResultScanner getScanner(String tableName, byte[] paramArrayOfByte) throws IOException;

	ResultScanner getScanner(String tableName, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2) throws IOException;
	...
	void mutateRow(String tableName, RowMutations paramRowMutations) throws IOException;

	Result append(String tableName, Append paramAppend) throws IOException;

	Result increment(String tableName, Increment paramIncrement) throws IOException;

	long incrementColumnValue(String tableName, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2,
	...
	void setAutoFlush(String tableName, boolean paramBoolean1, boolean paramBoolean2);

	long getWriteBufferSize(String tableName);

	void setWriteBufferSize(String tableName, long paramLong) throws IOException;
}
